...
- 59 curated Microsoft Security skills
...
This plugin ships **59 curated Microsoft Security skills** that teach an agent how security
...
- **Cloud and platform security** with `azure-landing-zone`, `epac`,
  `azure-diagnostics-at-scale`, `azure-policy`, `azure-key-vault`,
...
|---|---|---|
| **59 Microsoft Security skills** | Expertise, decision trees, workflows, and guardrails across the Microsoft Security portfolio | Security, Identity and Management, Compliance and Privacy, Cloud platform security, Landing zone governance |
...
- `Design a CAF-aligned management group hierarchy for our Azure tenant.`
- `Bootstrap an EPAC repository with dev and prod pacEnvironments using GitHub OIDC.`
- `Automatically send all landing zone resource logs to Sentinel using DINE policy.`
...
| Design or implement a CAF-aligned Azure landing zone (MG hierarchy, archetypes, subscription vending) | `azure-landing-zone` |
| Manage Azure Policy as code with a CI/CD pipeline (EPAC, pacEnvironments, plan/deploy workflow) | `epac` |
| Automatically route all resource diagnostic logs to Sentinel via DINE policy at scale | `azure-diagnostics-at-scale` |
...
| Cloud and platform security | Azure security architecture, landing zone governance, and control implementation | `azure-landing-zone`, `epac`, `azure-diagnostics-at-scale`, `azure-policy`, `azure-key-vault`, `azure-network-security-design`, `azure-firewall` |
